...
```{r, engine='bash'}
# you may need to install the [sra toolkit](https://www.ncbi.nlm.nih.gov/sra/docs/toolkitsoft/){target="_blank"}
...
- Convert BAM format to BED format (using [bedtools](https://bedtools.readthedocs.io/){target="_blank"})
```{r, engine='bash'}
